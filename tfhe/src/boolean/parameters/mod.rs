...
pub const FFT_STREAMING_SIZE: usize = 64;
pub const BSK_DEPTH: usize = 64;
pub const BSK_AXI_WIDTH: usize = 128;
pub const BSK_WIDTH: usize = 32;
pub const BSK_INT_WIDTH: usize = 8;
pub const BSK_SIZE: usize = (DEMO_PARAMETERS.glwe_dimension.0 + 1)
    * FFT_STREAMING_SIZE
    * BSK_DEPTH
    * 2
    * std::mem::size_of::<u64>();
